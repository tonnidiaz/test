...
class RITA extends Strategy {
    ...
    desc: string = "JUST A CE";
    buyCond(row: IObj): boolean {
        return (CE_ONLY.prototype.buyCond(row) || MACD_ONLY.prototype.buyCond(row) || MA_ONLY.prototype.buyCond(row)) || RSI_ONLY.prototype.buyCond(row)
    }

    sellCond(row: IObj): boolean {
        return (
            (CE_ONLY.prototype.sellCond(row) || MACD_ONLY.prototype.sellCond(row) || MA_ONLY.prototype.sellCond(row)) || RSI_ONLY.prototype.sellCond(row)
        );
    }
}
